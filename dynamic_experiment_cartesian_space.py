...
model_name = "3_robot_model"
model_path = f"C:/Users/smart/Downloads/desc/model/{model_name}.xml" 
...
with open('C:/Users/smart/Downloads/desc/data/trajectory_data.csv', 'w') as f:
    for q, dq, tau in zip(q_t, dq_t, torques_data):
        f.write(
            f"{q[0]},{q[1]},{q[2]},{q[3]}, {dq[0]}, {dq[1]}, {dq[2]}, {dq[3]}, {ddq[0]}, {ddq[1]}, {ddq[2]}, {ddq[3]}, {tau[0]}, {tau[1]}, {tau[2]}, {tau[3]}\n")
